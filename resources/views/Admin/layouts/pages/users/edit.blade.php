            ...
            <div class="card-body">
              <form action="{{ route('user.update',$users->id) }}" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name" value="{{ $users->name }}"class="form-control" id="basic-default-fullname" placeholder="Enter User Name">
                </div>

                <div class="mb-3">
                    <label class="form-label" for="basic-default-fullname">Email</label>
                    <input type="email" name="email" value="{{ $users->email }}" class="form-control" id="basic-default-fullname" placeholder="Enter User Email">
                </div>
